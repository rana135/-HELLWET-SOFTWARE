...
const Home = () => {
    ...
    return (
        <div>
            <div>
                {/* Search By Title */}
                <div class="flex w-screen justify-center p-5">
                    <div class="rounded-lg bg-gray-200 p-5 w-full lg:w-96">
                        <div class="flex">
                            ...
                            <input onChange={handleSearch} type="text" placeholder='Search By title' class="w-full bg-white pl-2 text-base font-semibold outline-0" id="" />
